...
```bash cURL
curl https://api.proteus.com/api/chain/markets
```
...
```bash cURL
curl https://api.proteus.com/api/chain/market/1
```
...
```bash cURL
curl https://api.proteus.com/api/chain/stats
```
...
```bash cURL
curl https://api.proteus.com/api/chain/oracle/submissions/1
```
