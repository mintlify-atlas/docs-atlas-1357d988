...
```bash cURL
curl https://api.proteus.com/auth/nonce/0x1234567890abcdef1234567890abcdef12345678
```
...
```bash cURL
curl -X POST https://api.proteus.com/auth/verify \
...
```bash cURL
curl -X POST https://api.proteus.com/api/embedded/auth/send-otp \
  -H "Content-Type: application/json" \
  -d '{
...
```bash cURL
curl -X POST https://api.proteus.com/api/embedded/auth/verify-otp \
  -H "Content-Type: application/json" \
  -d '{
    "email": "user@example.com",
    "otp": "123456"
...
```bash cURL
curl -X POST https://api.proteus.com/auth/refresh \
...
```bash cURL
curl https://api.proteus.com/auth/jwt-status \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."
```
...
```bash cURL
curl https://api.proteus.com/api/embedded/auth/status \
  --cookie "session=..."
```
...
```bash cURL
curl -X POST https://api.proteus.com/auth/logout \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."
```
